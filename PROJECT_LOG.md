...
- **Бэклог (с.33):** шары в круглой комнате катаются по полу вдоль купола и не ломают башню
  (нет от чего оттолкнуться) — нужно элегантное решение, согласовать и реализовать.
...
- **Шары в круглой комнате (с.33, открыто):** после перехода на круглый купол шары большую
  часть времени катаются внизу по полу вдоль стенки купола — оттолкнуться не от чего, башню
  не ломают, угроза не работает. Нужно элегантное решение (согласовать → реализовать).
- **Парящий стол ✅** (с.27).
